...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-bullets-bullet-list '("⦿" "◉" "✸" "✿" "◆"))
    (custom-set-faces
      `(org-document-title ((t (:inherit outline-1 :height 1.4 :family ,hosfamily))))
      `(org-level-1        ((t (:inherit outline-1 :height 1.5 :family ,hosfamily))))
      `(org-level-2        ((t (:inherit outline-2 :height 1.3 :family ,hosfamily))))
      `(org-level-3        ((t (:inherit outline-3 :height 1.1 :family ,hosfamily))))
      `(org-level-4        ((t (:inherit outline-4 :height 1.0 :family ,hosfamily))))
